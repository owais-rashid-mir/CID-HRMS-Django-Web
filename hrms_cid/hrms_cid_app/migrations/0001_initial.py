# Generated by Django 4.2.4 on 2023-09-26 20:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('computer_knowledge', models.CharField(choices=[('No', 'No'), ('Yes', 'Yes')], default='No', max_length=3)),
                ('computer_degree', models.CharField(choices=[('None', 'None'), ('Diploma', 'Diploma'), ('Degree', 'Degree')], default='None', max_length=7)),
                ('computer_skill', models.CharField(choices=[('None', 'None'), ('Excellent', 'Excellent'), ('Good', 'Good'), ('Poor', 'Poor')], default='None', max_length=9)),
