    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='hrms_cid_app.sections')),
            ],
        ),
        migrations.CreateModel(
            name='Employees',
            fields=[
                ...
                ('section_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='hrms_cid_app.sections')),
                ('supervisor_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='hrms_cid_app.supervisor')),
            ],
        ),
        migrations.CreateModel(
            name='Admin',
