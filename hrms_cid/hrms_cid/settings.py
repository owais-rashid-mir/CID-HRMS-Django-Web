"""
Django settings for hrms_cid project.
...
SECRET_KEY = 'django-insecure-&j)9yc%r_)z-&f4+f9qw1-ao#r0ogo-)a%svzk@z2zsipbe1#n'
...
AUTH_USER_MODEL = "hrms_cid_app.CustomUser"  # Where CustomUser is defined in models.py
...
WSGI_APPLICATION = 'hrms_cid.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'hrms_cid_db',  # Name of the database
        'USER': 'hrms_cid',
        'PASSWORD': 'hrms_cid_password',
        'HOST': 'localhost',
        'PORT': '3360'
    }
}
...
TIME_ZONE = 'Asia/Kolkata'  # For Indian time zone
